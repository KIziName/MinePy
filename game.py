...
class WeatherManager:
    def __init__(self, screen_width, screen_height):
        ...
        self.weather_timer = random.uniform(
            WEATHER_CHANGE_INTERVAL_MIN, WEATHER_CHANGE_INTERVAL_MAX
        )
...
class Game:
    ...
    def _handle_attack_or_break(self, wx, wy):
        ...
        if b_type != BLOCK_AIR:
            # Декоративные блоки (из NON_SOLID_BLOCKS) собираются сразу
            ...
            # Обычные блоки – дроп с возможной заменой на слиток/ингредиент
            drop_item = b_type
    ...
    def _handle_place_or_use(self, wx, wy):
        ...
        # Использование свитка телепортации
    ...
    def draw_menu(self):
        """Отрисовка главного меню через рендерер."""
        self.renderer.draw_menu()

    def render(self):
        """Отрисовка игрового мира через рендерер."""
