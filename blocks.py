...
# Удалены: ITEM_STAFF_*, ITEM_RING_*, ITEM_AMULET_*, ITEM_NECKLACE_*
...
ITEM_NAMES = {
    ...
    # Удалены названия посохов и колец/амулетов
...
# ------------------- РЕЦЕПТЫ КРАФТА (удалены посохи и кольца) -------------------
CRAFTING_RECIPES = [
    ...
    # удалены рецепты посохов и украшений
