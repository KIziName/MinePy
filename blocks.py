...
# ---------- 9.5. Настройки времени суток ----------
NIGHT_START = 14000   # начало ночи (игровые единицы, 0-24000)
NIGHT_END = 22000     # конец ночи (игровые единицы, 0-24000)
...
# ---------- 9.1. Настройки генерации мира---------
WORLD_SEED = None                # если None – случайное зерно, иначе число (например, 12345)
WORLD_MAX_X = None               # ограничение по X (в блоках), None – бесконечно

# ---------- 9.2. Настройки спавна мобов----------
MOB_SPAWN_LIMITS = {
