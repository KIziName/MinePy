...
PLAYER_WIDTH = 22
PLAYER_HEIGHT = 44
PLAYER_ANIM_SPEED = 21.0
DROPPED_ITEM_PULL_RADIUS = 140
WEATHER_CHANGE_INTERVAL_MIN = 30
WEATHER_CHANGE_INTERVAL_MAX = 120
WEATHER_TRANSITION_TIME = 3
...
LAND_HEIGHT_BASE = 40
LAND_HEIGHT_AMPLITUDE = 6
LAND_HEIGHT_FREQ = 0.04
LAND_HEIGHT_FREQ2 = 0.1
LAND_HEIGHT_AMPLITUDE2 = 3

DECORATION_CHANCE = 0.15
GRASS_CHANCE = 0.4
...
ITEM_NAMES = {
    ...
    ITEM_STAFF_FIRE: "Посох огня", ITEM_STAFF_ICE: "Посох льда",
    ITEM_STAFF_LIGHTNING: "Посох молнии", ITEM_STAFF_HEALING: "Посох лечения",
    ITEM_RING_STRENGTH: "Кольцо силы", ITEM_RING_PROTECTION: "Кольцо защиты",
    ITEM_AMULET_REGENERATION: "Амулет регенерации", ITEM_AMULET_SPEED: "Амулет скорости",
...
# ------------------- РЕЦЕПТЫ КРАФТА (полный список, без зелий) -------------------
CRAFTING_RECIPES = [
    ...
    ({'type': ITEM_SAPPHIRE, 'count': 1}, [(ITEM_IRON_INGOT, 2), (ITEM_GEL, 1)]),  # был ITEM_LENS, удалён
    ({'type': ITEM_EMERALD, 'count': 1}, [(ITEM_GOLD_INGOT, 2), (ITEM_APPLE, 1)]),
    ({'type': ITEM_AMETHYST, 'count': 1}, [(ITEM_SILVER_INGOT, 2), (ITEM_GEL, 2)]),
    ({'type': ITEM_OPAL, 'count': 1}, [(ITEM_PLATINUM_INGOT, 2), (ITEM_GEL, 2)]),  # был ITEM_LENS
    ...
    ({'type': ITEM_ORANGE, 'count': 1}, [(ITEM_APPLE, 1), (ITEM_GEL, 1)]),  # был ITEM_LENS
    ...
    ({'type': ITEM_FISH_PUFFER, 'count': 1}, [(ITEM_GEL, 4), (ITEM_GEL, 1)]),  # был ITEM_POTION, заменён на ITEM_GEL
