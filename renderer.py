...
class GameRenderer:
    def __init__(self, game):
        ...
        # ---------- Подписки на события (через слабые ссылки) ----------
        game.player.subscribe('health_changed', self.on_health_changed)
        game.inventory.subscribe('inventory_updated', self.on_inventory_updated)
        game.inventory.subscribe('selected_slot_changed', self.on_selected_slot_changed)
        game.mob_manager.subscribe('mob_killed', self.on_mob_killed)
    ...
    # ----- Вспомогательные методы отрисовки предметов -----
    @staticmethod
