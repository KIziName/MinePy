    ...
    def update(self, player_x, player_y, is_night, player, dt):
        try:
            ...
            if self.spawn_timer >= 2.0:
                ...
                # ----- Определяем общий лимит мобов -----
                # Запасной лимит, если MOB_SPAWN_LIMITS не задан или все значения нулевые
                total_limit = 20
                ...
                if MOB_SPAWN_LIMITS:
                    ...
                    # Если суммарный лимит оказался нулём – используем запасной
                    if total_limit == 0:
                        total_limit = 20
