...
def draw_item_icon(surface, item_type, x, y, size=32):
    ...
    if item_type in (ITEM_SWORD_WOOD, ITEM_SWORD_COPPER, ITEM_SWORD_IRON, ITEM_SWORD_GOLD, ITEM_SWORD_DIAMOND):
        ...
        pygame.draw.line(surface, (255, 255, 255), (x + 10, y + size - 10), (x + size - 7, y + 7), 1) # Блик
        # Гарда
    ...
    # Детализированные Кирки
        ...
        # Рабочая часть кирки (изогнутое лезвие)
...
class Game:
    def __init__(self):
        ...
        # Таймер всплывающего оповещения о сохранении
    ...
    def save_world(self):
        ...
        try:
            ...
            # Включаем оповещение для игрока
            self.save_notification_timer = 120 # 2 секунды при 60 FPS
    ...
    def render(self):
        ...
        # Всплывающее оповещение о сохранении
        if self.save_notification_timer > 0:
    ...
    def draw_menu(self):
        ...
        # Ссылка строго НАД кнопкой «НОВАЯ ИГРА»
        btn_data = [
    ...
    def run(self):
        while self.running:
            ...
            elif self.game_state == "game": self.render()
